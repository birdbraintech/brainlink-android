...
public class BossaNova extends BrainLinkRobot{
    ...
    static final byte[] BOSSA_NOVA = new byte[] {0x2A, 0x49, 0x03, 0x49, 0x02, 0x0B, 0x6D, 0x03, ByteUtils.intToUnsignedByte(0xB6), 0x03, 0x15, 0x02, ByteUtils.intToUnsignedByte(0xD5), 0x00, ByteUtils.intToUnsignedByte(0xE1), 0x00, 0x00};
